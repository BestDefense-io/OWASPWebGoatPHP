 ...
 * Copy this to application.php when using Docker
 */
 ...
 */
if (strpos(HttpRequest::Host(), "localhost") !== false) {
 ...
 *
 * DOCKER NOTE: The host parameter is set to "webgoatphp-mysql" which is the Docker container name
 */
